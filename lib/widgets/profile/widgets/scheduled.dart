...
class Scheduled extends StatelessWidget {
  ...
  final List<ScheduledModel> scheduled = [
    ScheduledModel(title: "Ahimbisibwe Job", date: "Today, 9AM - 10AM"),
    ScheduledModel(title: "Ssentong Hamza", date: "Tomorrow, 5PM - 6PM"),
    ScheduledModel(title: "Yiga Rony", date: "Wednesday, 9AM - 10AM"),
  ];
